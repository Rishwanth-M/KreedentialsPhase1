  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute w-[600px] h-[600px] bg-lime-500/20 blur-[180px] rounded-full top-1/3 left-1/4 animate-pulse"></div>
        <div className="absolute w-[400px] h-[400px] bg-lime-400/10 blur-[160px] rounded-full bottom-1/3 right-1/4"></div>
      </div>
